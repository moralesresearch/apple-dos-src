...
40 VTAB 4:A$ = "Apple DOS 3.3 System Master Disk": GOSUB 1000
50 VTAB 7:A$ = "January 25, 2021": GOSUB 1000
60 PRINT D$; "BLOAD LOADER.OBJ"
70 CALL 4096 : REM FAST LOAD IN BASIC
80 VTAB 10: CALL -958: A$= "(C) 2021 Morales Research Corp, 1980 Apple Computers, Inc"
